...
const TAG_TOOLTIPS: Record<Tag, string> = {
  ...
  HearthActive: 'Established fire source. Eliminates cold damage and unlocks cooking and boiling.',
  SustainedFire: 'Upgraded fire infrastructure. Eliminates cold damage and unlocks Signal Beacon.',
